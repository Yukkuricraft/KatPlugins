...
public class ScalaPluginLoader implements PluginLoader {
    ...
    public ScalaPluginLoader() {
        this.scalaVersion = net.katsstuff.bukkit.magicalwarps.BuildInfo.scalaVersion;
        this.libraryDependencies = net.katsstuff.bukkit.magicalwarps.BuildInfo.libraryDependencies;
        this.jarInJarFiles = net.katsstuff.bukkit.magicalwarps.BuildInfo.jarInJarFiles;
    }
