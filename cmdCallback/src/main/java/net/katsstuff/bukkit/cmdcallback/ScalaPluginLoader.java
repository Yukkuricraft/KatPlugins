...
public class ScalaPluginLoader implements PluginLoader {
    ...
    public ScalaPluginLoader() {
        this.scalaVersion = net.katsstuff.bukkit.cmdcallback.BuildInfo.scalaVersion;
        this.libraryDependencies = net.katsstuff.bukkit.cmdcallback.BuildInfo.libraryDependencies;
        this.jarInJarFiles = net.katsstuff.bukkit.cmdcallback.BuildInfo.jarInJarFiles;
    }
