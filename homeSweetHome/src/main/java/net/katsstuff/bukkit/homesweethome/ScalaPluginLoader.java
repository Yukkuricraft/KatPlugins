...
public class ScalaPluginLoader implements PluginLoader {
    ...
    public ScalaPluginLoader() {
        this.scalaVersion = net.katsstuff.bukkit.homesweethome.BuildInfo.scalaVersion;
        this.libraryDependencies = net.katsstuff.bukkit.homesweethome.BuildInfo.libraryDependencies;
        this.jarInJarFiles = net.katsstuff.bukkit.homesweethome.BuildInfo.jarInJarFiles;
    }
